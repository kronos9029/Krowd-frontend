            ...
            <Box sx={{ maxWidth: { md: 360 } }}>
              ...
              <MotionInView variants={varFadeInUp}>
                <Typography sx={{ color: 'common.white' }}>
                  Mục tiêu của chúng tôi là tạo ra một sản phẩm và dịch vụ mà bạn hài lòng và sử
                  dụng nó hàng ngày. Đây là lý do tại sao chúng tôi liên tục làm việc trên các dịch
                  vụ của chúng tôi để làm cho nó tốt hơn mỗi ngày và thực sự lắng nghe những gì
                  người dùng của chúng tôi nói.
                </Typography>
              </MotionInView>
